...
function playGame() {
  ...
  let guessedNumber = parseInt(document.getElementById("number-guess").value);
...
function displayHistory() {
  let index = guessedHistory.length - 1; // TODO
  let list = "<ul class='list-group'>";
  // *CODE GOES BELOW HERE *
  console.log(guessedHistory);
  if (guessedHistory) {
    while (index >= 0) {
      list += `<li class='list-group-item'>You guessed ${guessedHistory[index]}</li>`;
      index--;
    }
  }
  list += "</ul>";
